export const portfolioData = {
  fr: {
    ...
    description:
      "🎓 Titulaire d'un Master 2 Informatique, parcours Intelligence Artificielle | À la recherche d'un CDI à partir de Septembre 2026",
    ...
    home: {
      ...
      intro:
        "Je m'appelle Channel NIANGA, ingénieur en Intelligence Artificielle avec une solide base en informatique et en ingénierie logicielle. J'ai acquis une expérience dans la conception et le développement de systèmes robustes orientés données. Mes domaines d'intérêt incluent le machine learning, le deep learning, le traitement du langage naturel (NLP) et la vision par ordinateur. Je suis actuellement ouvert à des opportunités en CDI à partir de Septembre 2026.",

      whoAmI: {
        title: "🔍 Qui suis-je ?",
        content:
          "Ingénieur en Intelligence Artificielle avec une solide base en algorithmique, statistiques et modélisation. Développeur Python expérimenté, maîtrisant des frameworks tels que TensorFlow, PyTorch et Scikit-learn. Curieux et rigoureux, j'explore et conçois des solutions pour résoudre des problèmes complexes.",
      },

      whatYouWillFind: {
        title: "🛠 Ce que vous trouverez ici",
        content:
          "Mes projets académiques et personnels en intelligence artificielle (classification, prédiction, génération de données, etc.), ainsi que mes compétences techniques (Python, SQL, optimisation de modèles...). Vous y trouverez également mon parcours, mes expériences et mes ambitions professionnelles en tant qu'ingénieur en IA.",
      },

      contact: {
        title: "Envie d'échanger ?",
        content:
          "Contactez-moi sur LinkedIn ou envoyez-moi un mail. Ou encore, rendez-vous dans la section Contact pour m'envoyer un message.",
      },

      quote:
        "L'IA est un outil puissant pour façonner demain, j'ai hâte d'y contribuer.",
    },
...
**Domaines** : Machine Learning, Deep Learning, Computer Vision, NLP, Data Analysis, Data Visualization, Software Engineering  
      ...
      ia: [
        {
          ...
          description:
            "Analyse du taux de désabonnement (churn) des clients télécom via EDA et modélisation (Régression logistique, SVM, AdaBoost, XGBoost). Précision jusqu'à 82%. Dataset : WA_Fn-UseC_-Telco-Customer-Churn.",
        ...
        },
        {
          ...
          description:
            "Ce projet propose une solution simple et efficace pour la segmentation d'image en utilisant deux algorithmes populaires : GrabCut et Graph Cuts. La segmentation d'image est un processus essentiel dans la vision par ordinateur, permettant d'isoler des objets d'intérêt dans une image.",
        ...
        },
        {
          ...
          description:
            "Prédiction des résultats de matchs de football et simulation de stratégies de paris grâce à l'analyse des cotes des bookmakers. Comprend un pipeline d'apprentissage automatique (XGBoost, Random Forest, DNN), des stratégies de paris adaptatives basées sur le critère de Kelly, un système de détection de manipulation des matchs fondé sur l'évolution des cotes et l'algorithme Isolation Forest, ainsi qu'une interface graphique interactive permettant aux utilisateurs de sélectionner n'importe quel championnat et d'effectuer une analyse complète.",
      ...
      dev: [
        {
          ...
          description:
            "Ce projet implémente une version avancée du jeu Mastermind dans un cadre adversarial, où deux intelligences artificielles, Alice (le codeur) et Bob (le devineur) s'affrontent avec des stratégies variées.",
        ...
        },
        {
          title: "Jeu de la vie",
          description:
            "Ce projet en C++ met en œuvre le Jeu de la vie de Conway, un automate cellulaire classique conçu par le mathématicien John Conway. Le Jeu de la vie est un jeu sans joueur dans lequel l'évolution de la grille est déterminée par son état initial, selon des règles spécifiques régissant l'interaction entre les cellules.",
        ...
        },
        {
          ...
          description:
            "Ce projet comprend deux versions d'un système de gestion de courses de ski développé en C. L'objectif est de traiter efficacement les données relatives à une course de ski, en classant les skieurs selon qu'ils ont terminé la course ou qu'ils ont abandonné.",
      ...
      academic: [
        {
          title: "Atelier 4.0",
          description:
            "Ce projet de simulation d'atelier utilise la plateforme JADE (Java Agent DEvelopment Framework) pour créer une simulation interactive d'un environnement de production. Cette simulation implémente un atelier comprenant des robots, des produits et des agents de simulation travaillant de manière coordonnée.",
          github: "https://github.com/Niabbach/atelier4.0",
          technologies: ["Java", "JADE"],
        },
        {
          title: "Synoptique Dymola",
          description:
            "Visualiseur synoptique interactif pour résultats de simulation Dymola. Ce projet permet d'explorer les résultats temporels d'une simulation électrique via un synoptique animé et un curseur de temps réel, directement dans le navigateur.",
          github: "https://github.com/Niabbach/synoptic",
          technologies: ["Python", "DyMat", "Scipy", "HTML/CSS", "Javascript"],
        },
      ],
    },

    // ─── CONTACT (toutes les clés traduites) ───────────────────────────────────
    contact: {
      title: "📬 Me Contacter",
      subtitle: "Envoyez-moi un message ou connectez-vous sur les réseaux sociaux",
      ...
      //responseTimeText: "Je vous répondrai généralement dans les 24-48 heures.",
      ctaTitle: "Prêt à collaborer ?",
      ctaText:
        "Que ce soit pour un projet, une opportunité de CDI ou simplement pour discuter d'IA, n'hésitez pas à me contacter. Je serais ravi d'échanger avec vous !",
    ...
    seo: {
      ...
      description:
        "Étudiant en Master 2 IA spécialisé en Machine Learning, Deep Learning et Computer Vision. Portfolio avec projets concrets en Python, TensorFlow, PyTorch.",
      keywords:
        "data scientist, intelligence artificielle, machine learning, deep learning, python, tensorflow, pytorch, computer vision, nlp, portfolio, stage IA",
    },
  },
  ...
  en: {
    ...
    description:
      "AI Engineer and Data professional with experience in fullstack development and building robust software systems. Master's degree holder in Computer Science, specialized in Artificial Intelligence. Open to full-time opportunities starting September 2026.",
    email: "channeliba@yahoo.com",
    location: "France",
    github: "https://github.com/Niabbach",
    linkedin: "https://www.linkedin.com/in/channel-nianga-44095615b",
    ...
    home: {
      ...
      intro:
        "My name is Channel NIANGA, an AI Engineer with a strong background in computer science and software engineering. I have experience in designing and building robust data-driven systems. My areas of interest include machine learning, deep learning, natural language processing (NLP), and computer vision. I am currently open to full-time opportunities starting September 2026.",

      whoAmI: {
        title: "🔍 Who am I?",
        content:
          "AI Engineer with a strong foundation in algorithms, statistics, and modeling. Experienced Python developer, proficient with frameworks such as TensorFlow, PyTorch, and Scikit-learn. Curious and rigorous, I design and explore solutions to solve complex problems.",
      },

      whatYouWillFind: {
        title: "🛠 What you will find here",
        content:
          "My academic and personal projects in artificial intelligence (classification, prediction, data generation, etc.), along with my technical skills (Python, SQL, model optimization...). You will also find my background, experience, and professional ambitions as an AI Engineer.",
      },

      contact: {
        title: "Want to chat?",
        content:
          "Contact me on LinkedIn or send me an email. Or go to the Contact section to send me a message.",
      },
...
**Domains**: Machine Learning, Deep Learning, Computer Vision, NLP, Data Analysis, Data Visualization, Software Engineering  
      ...
      ia: [
        {
          ...
          description:
            "Analysis of telecom customer churn rates using EDA and machine learning models (Logistic Regression, SVM, AdaBoost, XGBoost). Accuracy up to 82%. Dataset: WA_Fn-UseC_-Telco-Customer-Churn.",
          github: "https://github.com/Niabbach/Telecom-churn-prediction",
          technologies: ["Python", "Pandas", "Numpy", "Seaborn", "Matplotlib", "Scikit-learn", "Xgboost"],
        },
        {
        ...
        },
        {
          ...
          description:
            "This project presents a comprehensive solution for detecting pneumonia from chest X-ray images using a Convolutional Neural Network (CNN). The project involves training a model to classify images into two categories: indicative of pneumonia or normal.",
          github: "https://github.com/Niabbach/Pneumonia-detection-model",
          technologies: ["Python", "TensorFlow", "Matplotlib", "PIL"],
        },
        {
          ...
          description:
            "This project offers a simple and effective solution for image segmentation using two popular algorithms: GrabCut and Graph Cuts. Image segmentation is an essential process in computer vision, enabling the isolation of objects of interest within an image.",
          github: "https://github.com/Niabbach/Segmentation-Image",
          technologies: ["Python", "OpencV", "Matplotlib", "Numpy", "NetworkX"],
        },
        {
      ...
      dev: [
        {
          title: "Mastermind adversarial",
          description:
            "This project implements an advanced version of the Mastermind game in a competitive setting, where two artificial intelligences, Alice (the coder) and Bob (the guesser), compete using a variety of strategies.",
          github: "https://github.com/Niabbach/mastermind_adversarial",
          technologies: ["Python"],
        },
        {
          title: "TP Docker",
          description:
            "This project consists of a GraphQL application that interacts with a MongoDB database to provide data on services, with a visualization interface based on D3.js.",
          github: "https://github.com/Niabbach/tp-docker",
          technologies: ["HTML/CSS", "Javascript", "Node.js", "Apollo", "MongoDB", "D3.js", "Docker"],
        },
        {
          title: "ShapeGame",
          description:
            "ShapeGame is a Java-based graphical game that allows users to create, move, resize, and delete geometric shapes (circles and rectangles) within an interactive user interface. This project implements a simple MVC pattern, state management for user interactions, and action history tracking.",
          github: "https://github.com/Niabbach/ShapeGame",
          technologies: ["Java"],
        },
        {
          title: "Role Playing Game",
          description:
            "This project implements a based adventure game in C++. The game includes characters like the player's hero, friendly NPCs (Lambda), and various monsters (Serpent, Renard, Fee, Centaurus). The player can explore different environments, engage in combat, and make decisions to progress through the game.",
          github: "https://github.com/Niabbach/Role-Playing-Game",
          technologies: ["C++"],
        },
        {
          title: "Game of life",
          description:
            "This C++ project implements Conway's Game of Life, a classic cellular automaton devised by mathematician John Conway. The Game of Life is a zero-player game where the evolution of the grid is determined by its initial state, following specific rules for cell interaction.",
          github: "https://github.com/Niabbach/Game-of-life",
          technologies: ["C++"],
        },
        {
          ...
          description:
            "This project consists of two versions of a ski race management system implemented in C. The goal is to efficiently handle data related to a ski race event, categorizing skiers based on whether they completed the race or abandoned.",
          github: "https://github.com/Niabbach/Ski-race-Management",
          technologies: ["C"],
        },
      ],
      ...
      academic: [
        {
          title: "Workshop 4.0",
          description:
            "This workshop simulation project uses the JADE (Java Agent DEvelopment Framework) platform to create an interactive simulation of a production environment. The simulation implements a workshop comprising robots, products, and simulation agents working in coordination.",
          github: "https://github.com/Niabbach/atelier4.0",
          technologies: ["Java", "JADE"],
        },
        {
          title: "Dymola Synoptic",
          description:
            "Interactive synoptic display for Dymola simulation results. This project allows users to explore the time-series results of an electrical simulation via an animated synoptic display and a real-time slider, directly in the browser.",
          github: "https://github.com/Niabbach/synoptic",
          technologies: ["Python", "DyMat", "Scipy", "HTML/CSS", "Javascript"],
        },
      ],
    ...
    // ─── CONTACT (all keys translated) ────────────────────────────────────────
    contact: {
      title: "📬 Contact Me",
      subtitle: "Send me a message or connect on social media",
      ...
      //responseTimeText: "I typically respond within 24-48 hours.",
      ctaTitle: "Ready to collaborate?",
      ctaText:
        "Whether it's for a project, a full-time opportunity, or simply to discuss AI, feel free to reach out. I'd love to connect!",
    ...
    seo: {
      ...
      description:
        "Master's 2 student in AI specializing in Machine Learning, Deep Learning and Computer Vision. Portfolio with concrete projects in Python, TensorFlow, PyTorch.",
      keywords:
        "data scientist, artificial intelligence, machine learning, deep learning, python, tensorflow, pytorch, computer vision, nlp, portfolio, internship AI",
    },
  },
};
